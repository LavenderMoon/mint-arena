...
{ PSA(persistant), -16 },
{ PSA(ammo), -16 },
{ PSA(ammoclip), -16 }, // LM: Limit to 16 bits per ammo type
{ PSA(weapons), -2 }, // LM: Limit to 2 bits per weapon. Used so you can have 2 of each weapon.
{ PSA(powerups), 32 },
{ PSF(contents), 32 },
